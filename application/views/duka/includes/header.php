...
<html class="no-js" lang="zxx">
   <head>
      ...
      <title><?php echo $this->data['frontTitle'] ?></title>
      <meta name="description" content="">
      <meta name="viewport" content="width=device-width, initial-scale=1">
      <!-- Place favicon.ico in the root directory -->
      <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url('assets/duka/img/favicon.png')?>">
      <!-- CSS here -->
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/jquery.toast.min.css') ?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/preloader.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/bootstrap.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/meanmenu.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/animate.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/owl-carousel.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/swiper-bundle.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/backtotop.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/magnific-popup.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/nice-select.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/flaticon/flaticon.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/font-awesome-pro.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/whatsapp.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/default.css')?>">
      <link rel="stylesheet" href="<?php echo base_url('assets/duka/css/style.css')?>">

      <?php
      if(count($this->data['cssdepan']) > 0):
        foreach($this->data['cssdepan'] as $cssdepan): ?>
            <link rel="stylesheet" href="<?php echo $cssdepan ?>">
        <?php endforeach;
      endif ?>
   </head>
   <body>
    ...
    <a href="http://wa.me/<?php echo $noWA ?>?text=Halo Jagodi, boleh minta informasinya?    ref: <?php echo current_url() ?>" target="_blank" class="whatsapp-widget">
