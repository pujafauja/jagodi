                        ...
                        <div class="col-xl-6 col-lg-7">
                            <div class="header-inner-start">
                                ...
                                <div class="support d-none d-sm-block">
                                    <p>Butuh Bantuan? <a href="tel:+001123456789">+001 123 456 789</a></p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3 col-md-8 col-sm-8 col-8">
                            <div class="header__info">
                                <div class="logo">
                                    <a href="index.html" class="logo-image"><img src="<?php echo base_url() ?>assets/duka/img/logo/logo1.svg" alt="logo"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="header__search">
                                <form action="#">
                                    <div class="header__search-box">
                                        <input class="search-input" type="text" placeholder="Saya sedang mencari...">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-4 col-sm-4 d-lg-block d-none">
                                            ...
                                            <ul>
                                                <li>
                                                  <div class="cart__title">
                                                    ...
                                                    <span>(1 Barang dalam keranjang)</span>
                                                  </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="cart__inner d-flex">
                                                      <div class="cart__thumb">
                                                        <a href="product-details.html">
                                                          <img src="<?php echo base_url() ?>assets/duka/img/cart/20.jpg" alt="">
                                                        </a>
                                                      </div>
        ...
        <div class="header__bottom">
            <div class="container">
                <div class="row g-0 align-items-center">
                    <div class="col-lg-3">                        
                        <div class="cat__menu-wrapper side-border d-none d-lg-block">
                            <div class="cat-toggle">
                                <button type="button" class="cat-toggle-btn cat-toggle-btn-1"><i class="fal fa-bars"></i> Kategori</button>
                                <div class="cat__menu">
                                        ...
                                        <div class="mega-menu">
                                            <div class="container container-mega">
                                                <ul>
                                                    ...
                                                    <li class="mega-image hover-effect" style="background-image: url(<?php echo base_url() ?>assets/duka/img/bg/menu-item.jpg);"> 
                                                        <ul>
                                                          <li><a href="shop.html">
                    ...
                    <div class="col-lg-3 col-md-6 col-4 d-lg-none d-block">
    ...
    <div class="offcanvas__area">
        ...
        <div class="offcanvas__content">
            <div class="offcanvas__logo mb-40">
                <a href="index.html">
                <img src="<?php echo base_url() ?>assets/duka/img/logo/logo-white.png" alt="logo">
                </a>
            </div>
