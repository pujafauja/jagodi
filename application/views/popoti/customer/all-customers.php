...
<script type="text/javascript">
    ( function ( $ ) {
        ...
        $(document).on('click', '.choose-customer', function(e){
            ...
            var last   = $(this).closest('tr').find('td').eq(3).text();

            $('input[name="cust-nama"]').val(nama);
            $('input[name="customerid"]').val($(this).data('id'));
            $('input[name="iscustomer"]').val('true');
            $('input[name="district"]').val(alamat);
            $('input[name="district-id"]').val($(this).data('desa'));
            $('input[name="no-hp"]').val(phone);
            $('#last_service').text(last);
            $('#total_come').text($(this).data('come'));
