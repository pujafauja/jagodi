    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table id="itemtradein-datatable" class="table dt-responsive nowrap w-100 table-sm">
                    <thead>
                        <tr>
                            <!-- <th>date</th> -->
                            <th>name</th>
...
<script type="text/javascript">
    ( function ( $ ) {
        ...
        {
            var dataTable = $('#itemtradein-datatable').DataTable( {
                "serverSide": true,
                "stateSave" : false,
                "bAutoWidth": true,
                "oLanguage": {
                ...
                "ajax":{
                    url : base_url+"Tradein/add-tradein-json",
                    type: "post",
                    error: function(){ 
        ...
        $(document).on('click', '.choose', function(e){
            var tanggal_beli    = $(this).closest('tr').find('td').eq(0).text();
            ...
            $('input[name="tanggal_beli"]').val($(this).data('tanggal_beli'));
