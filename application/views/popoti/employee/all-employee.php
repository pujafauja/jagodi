    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table id="employees-datatable" class="table dt-responsive nowrap w-100 table-sm">
                    <thead>
                        <tr>
                            <th>NIK</th>
                            <th>Nama</th>
    ...
    ( function ( $ ) {
        ...
        if( $.isFunction($.fn.DataTable) )
        {
            var dataTable = $('#employees-datatable').DataTable( {
                ...
                "ajax":{
                    url : base_url+"employee/employee_json_search",
                    type: "post",
                    error: function(){ 
        ...
        $(document).on('click', '.chooseEmployee', function(e){
            var nama     = $(this).closest('tr').find('td').eq(1).text();

            $('input[name="employee"]').val(nama);
