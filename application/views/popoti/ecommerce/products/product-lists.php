    ...
    <div class="col-md-3 col-xl-2">
        <div class="card-box product-box">
            ...
            <div class="product-action">
                <a href="<?php echo base_url('ecommerce/edit-product/'.encode($pro->id)) ?>" class="btn btn-success btn-xs waves-effect waves-light"><i class="mdi mdi-pencil"></i></a>
                <a href="<?php echo base_url('ecommerce/delete-product/'.encode($pro->id)) ?>" class="btn btn-danger btn-xs waves-effect waves-light delete-product"><i class="mdi mdi-close"></i></a>
            </div>
