    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table id="po-datatable" class="table dt-responsive nowrap w-100 table-sm">
                    <thead>
                        <tr>
...
<script type="text/javascript">
    ( function ( $ ) {
        ...
        {
            var dataTable = $('#po-datatable').DataTable( {
                "serverSide": true,
                "stateSave" : false,
                "bAutoWidth": true,
                "oLanguage": {
                ...
                "ajax":{
                    url : base_url+"purchase/po-datatable<?php echo (isset($_GET['direct-retrieve'])) ? '?direct-retrieve=1' : '' ?>",
                    data: {exists: '<?php echo json_encode($exists); ?>'},
                    type: "post",
                    error: function(){ 
