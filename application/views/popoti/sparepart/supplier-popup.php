    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                <table id="suppliers-datatable" class="table dt-responsive nowrap w-100 table-sm">
                    <thead>
                        <tr>
                            <th>Code</th>
                            <th>Supplier Name</th>
    ...
    ( function ( $ ) {
        ...
        if( $.isFunction($.fn.DataTable) )
        {
            var dataTable = $('#suppliers-datatable').DataTable( {
                ...
                "ajax":{
                    url : base_url+"sparepart/suppliers-datatable",
                    type: "post",
                    error: function(){ 
