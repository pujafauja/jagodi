<form action="<?php echo base_url('Cafe/cafe_data') ?>" data-type="add" method="POST">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" name="nomor_nota" id="nomor_nota" value="<?php echo getNoFormat('CF') ?>" readonly="" class="form-control">
