...
<script type="text/javascript">
    ( function ( $ ) {
        ...
        $(document).on('click', '.chooseWasher', function(event) {
            event.preventDefault();
            $('input[name=washer]').val($(this).closest('tr').find('td').eq(0).text())
            $('input[name=washerid]').val($(this).data('id'))
